...
# =============================
# SCREENSAVER VARIABLES (pic.png bouncing sprite)
# =============================
def _load_sprite(path):
    """Load and thumbnail a PNG sprite, returning (image, w, h)."""
    img = Image.open(path).convert("1")
    max_size = (32, 32)
    # thumbnail() resizes in-place BUT only if larger — reassign to be safe
